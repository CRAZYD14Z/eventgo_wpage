    ...
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 450px; margin-right: 0; margin-top: 0; margin-bottom: 0; height: 100%;">
        <div class="modal-content border-0 shadow-lg" style="height: 100vh; border-radius: 0;">
            ...
            <div class="modal-header bg-white border-bottom py-3">
                <h5 class="modal-title fw-bold text-dark"><i class="bi bi-cart3 me-2"></i><?= Trd(1) ?></h5>
            ...
            <div class="modal-body p-0 bg-light">
                ...
                <div class="bg-white border-bottom shadow-sm">
                    <div id="resumenFecha" class="p-3 d-flex justify-content-between align-items-center d-none">
                        <div>
                            <span class="small text-muted d-block text-uppercase fw-bold" style="font-size: 0.65rem;"><?= Trd(2) ?></span>
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm shadow-sm" id="btnReabrirCalendario">
                            <?= Trd(3) ?> <i class="fa-regular fa-calendar-check"></i>
                        </button>
                    ...
                    <div id="contenedorCalendario" class="p-3">
                        <label class="small fw-bold text-muted text-uppercase d-block mb-2 text-center"><?= Trd(4) ?></label>
                ...
                <div class="bg-white p-3 border-bottom mb-3 shadow-sm">
                    <div class="row g-2 text-center">
                        <div class="col-6 border-end">
                            <label class="small fw-bold text-primary text-uppercase d-block mb-1" style="font-size: 0.65rem;"><?= Trd(6) ?></label>
                            <select id="hInicio" class="form-select form-select-sm border-0 bg-light text-center fw-bold rounded-3"></select>
                        </div>
                        <div class="col-6">
                            <label class="small fw-bold text-success text-uppercase d-block mb-1" style="font-size: 0.65rem;"><?= Trd(7) ?></label>
            ...
            <div class="modal-footer flex-column bg-white border-top p-3 shadow-lg">
                <div class="w-100 mb-3">
                    <div class="d-flex justify-content-between mb-1 small text-muted">
                        <span id="Articulos"><?= Trd(8) ?> (0 <?= Trd(9) ?>)</span>
                    ...
                    <div class="d-flex justify-content-between mb-1 small text-muted">
                        <span id="EtiquetaCupon"><?= Trd(10) ?> ( <?= Trd(11) ?> )</span>
                        <span id="Descuento">$0.00</span>
                    </div>                    

                    <div class="d-flex justify-content-between fw-bold fs-5">
                        <span><?= Trd(12) ?></span>
                        <span class="text-primary text-end">$0.00<br><small class="text-muted fw-normal" style="font-size: 0.7rem;"><?= Trd(13) ?></small></span>
                    </div>
                </div>
