...
?> 
<div class="party-divider"><span>📍 🗺️ 📍</span></div>
    <section class="location-section mb-5">
        <div class="row align-items-center g-4">
            ...
            <div class="col-md-7">
                <div class="ratio ratio-16x9 rounded-4 overflow-hidden" style="border:3px solid var(--pink); box-shadow: 6px 6px 0 rgba(255,110,180,.2);">
                        <?php if (PLACE_ID == ''){?>
                            <iframe
                                width="600"
                                height="450"
