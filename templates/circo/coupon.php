                            ...
                            <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            ...
                                            Al enviar este formulario, acepto la política de privacidad y los términos y condiciones, y doy mi consentimiento expreso por escrito a <?= COMPANY ?> para que me contacten por mensaje de texto y llamada telefónica, incluso si este número es de telefonía móvil o si estoy registrado en la lista de "No llamar". Entiendo que pueden contactarme por teléfono, correo electrónico, mensaje de texto o correo postal con respecto a servicios de marketing y que pueden llamarme utilizando equipos de marcación automática. Entiendo que puedo responder "STOP" para detener las comunicaciones en cualquier momento. Pueden aplicarse tarifas de mensajes y datos. Mi consentimiento no requiere compra.
                                            <?php }else{?>
                                            By submitting this form, I agree to the privacy policy and terms and conditions and give my express written consent to <?= COMPANY ?> to be contacted via text and phone call, even if this number is a wireless number or if I am presently listed on a Do Not Call list. I understand that I may be contacted by telephone, email, text message or mail regarding marketing services and that I may be called using automatic dialing equipment. I understand that I can reply STOP to STOP communications at any time. Message and data rates may apply. My consent does not require purchase.
                                            <?php }?>
                                        </label>
                                    </div>                                
