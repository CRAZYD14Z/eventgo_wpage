...
<nav class="navbar navbar-expand-lg sticky-top">
    <div class="container">
        ...
        <a class="navbar-brand" href="<?php echo URL_BASE?>">
            <img height="32px" src="<?php echo COMPANY_LOGO?>" alt="<?php echo COMPANY_NAME?>" class="me-2 rounded-circle" style="border:2px solid rgba(255,221,161,.4);">
            <?php echo COMPANY_NAME?>
        </a>

        <!-- Icono del Carrito (con Modal Trigger y Estilos del segundo nav) -->
        <div class="d-flex align-items-center ms-auto me-3 order-lg-last">
            <a class="nav-link position-relative p-2" href="#" id="cartIcon" onclick="$('#modalReserva').modal('show');">
                <i class="fas fa-shopping-cart fa-lg" style="color:var(--sand);"></i>
        ...
        <button class="navbar-toggler border-0" type="button" data-bs-toggle="collapse" data-bs-target="#menuPrincipal" style="color:var(--sky);">
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            <ul class="navbar-nav ms-auto">
                ...
                <!-- Dropdown Idiomas (Importado del primer nav) -->
                <li class="nav-item dropdown">
